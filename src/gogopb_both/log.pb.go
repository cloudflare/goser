	...
	for index < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := data[index]
				index++
				m.Protocol |= (HTTP_Protocol(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := data[index]
				index++
				m.HostStatus |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := data[index]
				index++
				m.Method |= (HTTP_Method(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for index < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := data[index]
				index++
				m.Protocol |= (Origin_Protocol(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Log) Unmarshal(data []byte) error {
	...
	for index < l {
		...
		case 1:
			...
			m.Timestamp = *(*int64)(unsafe.Pointer(&data[index]))
			index += 8
		case 2:
			if wireType != 0 {
				return proto.ErrWrongType
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := data[index]
				index++
				m.ZonePlan |= (ZonePlan(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := data[index]
				index++
				m.CacheStatus |= (CacheStatus(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 11:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := data[index]
				index++
				m.BytesDlv |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *HTTP) MarshalTo(data []byte) (n int, err error) {
	var i int
	_ = i
	var l int
	_ = l
	data[i] = 0x8
	i++
	i = encodeVarintLog(data, i, uint64(m.Protocol))
	data[i] = 0x10
	i++
	i = encodeVarintLog(data, i, uint64(m.Status))
	data[i] = 0x18
	i++
	i = encodeVarintLog(data, i, uint64(m.HostStatus))
	data[i] = 0x20
	i++
	i = encodeVarintLog(data, i, uint64(m.UpStatus))
	data[i] = 0x28
	i++
	i = encodeVarintLog(data, i, uint64(m.Method))
	data[i] = 0x32
	i++
	i = encodeVarintLog(data, i, uint64(len(m.ContentType)))
	i += copy(data[i:], m.ContentType)
	data[i] = 0x3a
	i++
	i = encodeVarintLog(data, i, uint64(len(m.UserAgent)))
	i += copy(data[i:], m.UserAgent)
	data[i] = 0x42
	i++
	i = encodeVarintLog(data, i, uint64(len(m.Referer)))
	i += copy(data[i:], m.Referer)
	data[i] = 0x4a
	i++
	i = encodeVarintLog(data, i, uint64(len(m.RequestURI)))
...
func (m *Origin) MarshalTo(data []byte) (n int, err error) {
	var i int
	_ = i
	var l int
	_ = l
	data[i] = 0xa
	i++
	i = encodeVarintLog(data, i, uint64(m.Ip.Size()))
	...
	data[i] = 0x10
	i++
	i = encodeVarintLog(data, i, uint64(m.Port))
	data[i] = 0x1a
	i++
...
func (m *Log) MarshalTo(data []byte) (n int, err error) {
	...
	data[i] = 0x9
	i++
	*(*int64)(unsafe1.Pointer(&data[i])) = m.Timestamp
	i += 8
	data[i] = 0x10
	i++
	i = encodeVarintLog(data, i, uint64(m.ZoneId))
	data[i] = 0x18
	i++
	i = encodeVarintLog(data, i, uint64(m.ZonePlan))
	data[i] = 0x22
	i++
	i = encodeVarintLog(data, i, uint64(m.Http.Size()))
	...
	data[i] = 0x2a
	i++
	i = encodeVarintLog(data, i, uint64(m.Origin.Size()))
	n3, err := m.Origin.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n3
	data[i] = 0x30
	i++
	i = encodeVarintLog(data, i, uint64(m.Country))
	data[i] = 0x38
	i++
	i = encodeVarintLog(data, i, uint64(m.CacheStatus))
	data[i] = 0x42
	i++
	i = encodeVarintLog(data, i, uint64(m.ServerIp.Size()))
	n4, err := m.ServerIp.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n4
	data[i] = 0x4a
	i++
	i = encodeVarintLog(data, i, uint64(len(m.ServerName)))
	i += copy(data[i:], m.ServerName)
	data[i] = 0x52
	i++
	i = encodeVarintLog(data, i, uint64(m.RemoteIp.Size()))
	n5, err := m.RemoteIp.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n5
	data[i] = 0x58
	i++
	i = encodeVarintLog(data, i, uint64(m.BytesDlv))
	data[i] = 0x62
	i++
	i = encodeVarintLog(data, i, uint64(len(m.RayId)))
	i += copy(data[i:], m.RayId)
	if m.XXX_unrecognized != nil {
		i += copy(data[i:], m.XXX_unrecognized)
	}
	return i, nil
