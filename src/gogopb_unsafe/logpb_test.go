...
func TestHTTPMarshalTo(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedHTTP(popr, false)
	size := p.Size()
	data := make([]byte, size)
...
func TestOriginMarshalTo(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedOrigin(popr, false)
	size := p.Size()
	data := make([]byte, size)
...
func TestLogMarshalTo(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedLog(popr, false)
	size := p.Size()
	data := make([]byte, size)
...
func TestHTTPStringer(t *testing3.T) {
...
func TestOriginStringer(t *testing3.T) {
	popr := math_rand3.New(math_rand3.NewSource(time3.Now().UnixNano()))
	p := NewPopulatedOrigin(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
...
func TestLogStringer(t *testing3.T) {
	popr := math_rand3.New(math_rand3.NewSource(time3.Now().UnixNano()))
	p := NewPopulatedLog(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
...
func TestHTTPSize(t *testing4.T) {
...
func BenchmarkHTTPSize(b *testing4.B) {
...
func TestOriginSize(t *testing4.T) {
	popr := math_rand4.New(math_rand4.NewSource(time4.Now().UnixNano()))
	p := NewPopulatedOrigin(popr, true)
	size2 := code_google_com_p_gogoprotobuf_proto2.Size(p)
	data, err := code_google_com_p_gogoprotobuf_proto2.Marshal(p)
...
func BenchmarkOriginSize(b *testing4.B) {
	popr := math_rand4.New(math_rand4.NewSource(616))
	total := 0
	pops := make([]*Origin, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedOrigin(popr, false)
	}
	b.ResetTimer()
...
func BenchmarkLogSize(b *testing4.B) {
	popr := math_rand4.New(math_rand4.NewSource(616))
	total := 0
	pops := make([]*Log, 1000)
	for i := 0; i < 1000; i++ {
